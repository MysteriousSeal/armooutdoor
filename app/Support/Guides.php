    ...
    public static function all(): array
    {
        return [
            [
                ...
                'updated' => '2026-09-06',
                'image' => 'images/guides/classification/hero.webp',
            ...
            [
                ...
                'url' => route('guides.premiere-seance'),
                'route' => 'guides.premiere-seance',
                'categories' => ['kit-stand-tir', 'stand-de-tir', 'temoin-de-chambre-vide', 'recuperateurs-de-douilles', 'housses-fourreaux-mallettes'],
                'published' => '2026-09-09',
                'updated' => '2026-09-09',
                'teaser' => 'Ce qu\'on vous demandera, ce qu\'on vous prêtera, et la seule chose à ne pas apporter.',
            ...
            [
                ...
                'url' => route('guides.optique'),
                'route' => 'guides.optique',
                'categories' => ['optiques', 'telemetres', 'longues-vues', 'pastilles-autocollantes'],
                'published' => '2026-09-09',
                'updated' => '2026-09-09',
                'teaser' => 'Le zéro est une distance. Ce que vaut un clic à 10, 25 et 50 mètres, et un convertisseur.',
                'summary' => 'MOA, MRAD et clics : ce qu\'un cran de tourelle déplace vraiment selon la distance, un convertisseur qui traduit vos centimètres d\'écart en clics, la séance de réglage dans l\'ordre et la parallaxe qu\'on oublie.',
            ],
            [
                'topic' => 'Camouflage',
