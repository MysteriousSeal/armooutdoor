...
@section('meta_description', 'Sept guides écrits par la boutique : les catégories D, C, B et A, les joules et les FPS, où l\'on peut tirer, les cibles, l\'entretien, le camouflage, et le glossaire du rayon.')
    ...
    <div class="container glab glab-index">
        ...
        <header class="glab-head">
            ...
            <p class="glab-head-lede">
                Sept pages écrites par la boutique, d'après ce qu'elle vend et ce qu'on lui
