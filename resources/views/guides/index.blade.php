...
@section('meta_description', 'Quatorze guides écrits par la boutique : la loi, le transport, vos données, les joules, les plombs, le CO2, le bruit, la lunette et l\'entretien.')
    ...
    <div class="container glab glab-index">
        ...
        <header class="glab-head">
            ...
            <p class="glab-head-lede">
                Quatorze pages écrites par la boutique, d'après ce qu'elle vend et ce qu'on lui
