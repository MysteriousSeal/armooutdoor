...
@section('meta_description', 'Onze guides écrits par la boutique : la loi et le transport des armes, vos données, les joules, la lunette, les cibles, l\'entretien et le camouflage.')
    ...
    <div class="container glab glab-index">
        ...
        <header class="glab-head">
            ...
            <p class="glab-head-lede">
                Onze pages écrites par la boutique, d'après ce qu'elle vend et ce qu'on lui
