/*!
 * Chart.js v4.4.7 — https://www.chartjs.org · MIT licence
 *
 * Fichier fourni tel quel (« vendored »), volontairement versionné dans le
 * dépôt : ce projet n'a ni build front ni bundler, et une balise vers un CDN
 * serait la seule dépendance externe à l'exécution de toute l'application.
 * Ne pas « nettoyer » ce blob minifié — il est là exprès.
 *
 * Pour le mettre à jour : récupérer dist/chart.umd.min.js de la version
 * voulue, replacer cet en-tête, et noter la version dans CHANGELOG.md.
 */
/**
